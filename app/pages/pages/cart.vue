            ...
            <div class="w-2/7">
                <div class=" bg-orange-100 p-5 rounded-lg">
                    <ul role="list">
                        ...
                        <li class="pb-3">
                            <h4 class="block mt-3 mb-3 text-md font-medium text-gray-900 dark:text-white">Delivery Type
                            </h4>
                            <div class="col-span-2 flex items-center gap-x-8">
                                ...
                                <div class="flex items-center">
                                    <input checked id="shipping-radio-2" type="radio" value="" name="shipping-radio"
                                        class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                        ...
                        <li class="pb-3 pt-4">
                            <button @click="CheckOutBtn" type="button"
                                class="w-full text-white flex justify-center items-center focus:ring-4 focus:outline-none focus:ring-pink-200 dark:focus:ring-pink-800 bg-[rgba(245,_127,_32,_1)] hover:bg-[rgb(223,_120,_37,_1)] font-medium rounded-lg text-sm px-5 py-2.5 text-center ease-in-out duration-300">Checkout</button>
                        </li>
                    </ul>
                </div>
            </div>
            ...
            <div class="bg-white">
                <div class="title flex justify-between items-center gap-3 px-3 py-3 border-b-2 mb-4">
                    ...
                    <div class="arrow flex gap-x-3">
                        <span
                            class="prev flex items-center justify-center w-6 h-6 rounded-full bg-[#F57F20] hover:bg-[#ff892b] cursor-pointer">
