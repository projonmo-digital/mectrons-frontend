  ...
  <Transition name="slide-fade">
    <div v-if="!isSocialDrawerOpen" class="fixed right-0 top-[30vh] z-50 flex flex-col items-end gap-3">
      ...
      <div class="flex flex-col gap-1 bg-white shadow-md border-orange-200 rounded-md p-1">
        <a class=" hover:scale-110 transition" target="_blank" href="https://www.facebook.com/profile.php?id=61559661892435&mibextid=JRoKGi">
          <icon class="w-6 h-6" name="logos:facebook" />
        </a>
        <a class=" hover:scale-110 transition relative" target="_blank"
          href="https://m.facebook.com/groups/1155393332352922/?ref=share&mibextid=NSMWBT">
          <icon class="w-2 h-2 absolute bottom-1 right-1" name="logos:facebook" />
          <icon class="w-6 h-6 text-primary" name="vaadin:group" />
        </a>
        <a class=" hover:scale-110 transition" target="_blank" href="https://x.com/mectrons?t=JUrbwJfQO0B2xnkyBrbVmg&s=09">
          <icon class="w-6 h-6" name="logos:twitter" />
        </a>
        <a class=" hover:scale-110 transition" target="_blank" href="https://www.instagram.com/mectrons1?igsh=MXJ1emF5M3VvNzR2Zg==">
