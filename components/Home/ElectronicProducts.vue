...
<template>
    ...
    <div class="mx-10 gap-y-10 mt-8">
        ...
        <hr class="mb-5">
        <div id="controls-carousel" class="relative w-full h-128 flex items-center" data-carousel="static">
            <!-- Carousel wrapper -->
            ...
            <!-- Slider controls -->
            <button type="button"
                class="absolute start-0 z-30 flex items-center justify-center px-4 cursor-pointer group focus:outline-none"
                data-carousel-prev>
                <span
            ...
            <button type="button"
                class="absolute end-0 z-30 flex items-center justify-center px-4 cursor-pointer group focus:outline-none"
                data-carousel-next>
                <span
                    class="inline-flex items-center justify-center w-10 h-10 rounded-full bg-white/30 dark:bg-gray-800/30 group-hover:bg-white/50 dark:group-hover:bg-gray-800/60 group-focus:ring-4 group-focus:ring-white dark:group-focus:ring-gray-800/70 group-focus:outline-none">
                    <svg class="w-4 h-4 dark:text-gray-800 rtl:rotate-180" aria-hidden="true"
