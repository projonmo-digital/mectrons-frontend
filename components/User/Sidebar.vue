        ...
        <div>
            <div class="s-categories bg-gray-100 px-3 py-4 rounded-md">
                ...
                <nuxt-link to="/user/create"
                    class="text-white flex items-center w-full gap-x-2 mt-5 bg-gradient-to-r from-cyan-400 via-cyan-500 to-cyan-600 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-cyan-300 dark:focus:ring-cyan-800 shadow-lg shadow-cyan-500/50 dark:shadow-lg dark:shadow-cyan-800/80 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2">
                ...
                <ul class="space-y-2 font-medium text-sm">
                    ...
                    <li>
                        <nuxt-link :to="`${auth?.user?.name?.replaceAll(' ', '-')}/${auth?.user?.id}/products`"
                            target="_blank"
                            class="flex items-center px-2 py-1 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 hover:text-gray-300 dark:hover:bg-gray-700 group active:bg-violet-700">
                    ...
                    <li>
                        <nuxt-link to="/user/announcement"
                            class="flex items-center px-2 py-1 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                            <svg class="flex-shrink-0 w-4 h-4 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white"
                                aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                fill="currentColor" viewBox="0 0 24 24">
                    ...
                    <li>
                        <nuxt-link to="/user/bookmark"
                            class="flex items-center px-2 py-1 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group active:bg-violet-700">
                            <svg class="flex-shrink-0 w-4 h-4 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white"
                                aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                fill="currentColor" viewBox="0 0 24 24">
                                <path
                    ...
                    <template v-if="token.getStatus">
                        <li @click.prevent="auth.logout()"
                            class="cursor-pointer flex items-center px-2 py-1 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group active:bg-violet-700">
                            <svg class="flex-shrink-0 w-4 h-4 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white"
