<template>
    ...
    <div class="mx-10 gap-y-10 mt-8">
        <h1 class="font-bold text-2xl">Electronic Products</h1>
        <div class="flex justify-end gap-5 text-xl mb-4">

            <button class="filter-btn active hover:bg-[rgba(251,_226,_205,_1)] hover:text-[rgba(245,_127,_32,_1)] "
                data-filter="all">All</button>
            <button class="filter-btn  active hover:bg-[rgba(251,_226,_205,_1)] hover:text-[rgba(245,_127,_32,_1)] "
                data-filter="Tips">Power Tools</button>
            <button class="filter-btn  active hover:bg-[rgba(251,_226,_205,_1)] hover:text-[rgba(245,_127,_32,_1)] "
                data-filter="Guides">Hand Tools</button>
            <button class="filter-btn  active hover:bg-[rgba(251,_226,_205,_1)] hover:text-[rgba(245,_127,_32,_1)] "
                data-filter="Cars">Plumbing</button>
