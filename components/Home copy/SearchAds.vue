                ...
                <div class="flex flex-wrap items-center justify-center  ">
                    <div id="mega-menu"
                        ...
                        <button id="dropdownDefaultButton" data-dropdown-toggle="dropdown"
                            ...
                            type="button">Select Make<svg class="w-2.5 h-2.5 ms-3" aria-hidden="true"
                        ...
                        <button id="dropdownDefaultButton" data-dropdown-toggle="dropdown"
                            class="bg-[#FFFFFF] focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-3 py-2.5 text-center inline-flex items-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
                            type="button">Select Model <svg class="w-2.5 h-2.5 ms-3" aria-hidden="true"
                                xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 10 6">
                                <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
                                    stroke-width="2" d="m1 1 4 4 4-4" />
                            </svg>
                        ...
                        <button id="dropdownDefaultButton" data-dropdown-toggle="dropdown"
                            class="bg-[#FFFFFF] focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-3 py-2.5 text-center inline-flex items-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
                            type="button">Select Engine <svg class="w-2.5 h-2.5 ms-3" aria-hidden="true"
                                xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 10 6">
                                <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
                                    stroke-width="2" d="m1 1 4 4 4-4" />
                            </svg>
                        ...
                        <button id="dropdownDefaultButton" data-dropdown-toggle="dropdown"
                            class="bg-[#FFFFFF] focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-3 py-2.5 text-center inline-flex items-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
                            type="button">Select Part <svg class="w-2.5 h-2.5 ms-3" aria-hidden="true"
                                xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 10 6">
                                <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
                                    stroke-width="2" d="m1 1 4 4 4-4" />
                            </svg>
                        ...
                        <button type="submit"
                            class="p-2.5 ms-2 text-sm font-medium text-gray-900 bg-[rgba(251,_226,_205,_1)] rounded-lg hover:bg-[rgb(255,191,139)] focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
            ...
            <div
                ...
                <figure
                    ...
                    <figcaption class="flex items-center justify-center ">
                        <img class="rounded-full w-10 h-10" src="assets/images/product-2.png"
                            alt="profile picture">
                        <div class="space-y-0.5  dark:text-white text-left rtl:text-right ms-3">
                            <div>Original Product</div>
                            <div class="text-xs text-gray-500 dark:text-gray-400">Only parts from trusted brands</div>
                        </div>
                    </figcaption>
                </figure>
                <figure
                    ...
                    <figcaption class="flex items-center justify-center ">
                        ...
                        <div class="space-y-0.5  dark:text-white text-left rtl:text-right ms-3">
                            ...
                            <div class="text-xs text-gray-500 dark:text-gray-400">Easy return /replacement</div>
                        </div>
                    </figcaption>
                </figure>
                <figure
                    ...
                    <figcaption class="flex items-center justify-center ">
                        ...
                        <div class="space-y-0.5  dark:text-white text-left rtl:text-right ms-3">
                            ...
                            <div class="text-xs text-gray-500 dark:text-gray-400">All over Bangladesh</div>
                        </div>
                    </figcaption>
                </figure>
            </div>
