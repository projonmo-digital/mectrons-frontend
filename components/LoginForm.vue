...
<template>
    <div class="mx-auto w-full bg-gray-100 border border-gray-200 rounded-lg shadow px-4 py-6 dark:bg-gray-800 dark:border-gray-700">
        <form class="space-y-6" @submit.prevent="handleSubmit">
            ...
            <div class="flex items-start">
                ...
                <nuxt-link to="/auth/forget-password" @click="toggleBtnFun" class="ms-auto text-sm text-blue-700 hover:underline dark:text-blue-500">Lost Password?</nuxt-link>
            </div>
            ...
            <div class="text-sm font-medium text-center text-gray-500 dark:text-gray-300">
                Not registered? <nuxt-link to="/auth/register" @click="toggleBtnFun" class="text-blue-700 hover:underline dark:text-blue-500">Create account</nuxt-link>
            </div>
