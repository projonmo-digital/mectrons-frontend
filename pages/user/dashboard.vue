            ...
            <div class="w-[calc(100%-basis-72)] w-full">
                <div class="mx-auto w-full max-w-screen-2xl">
                    <div class="bg-gray-100 rounded-md px-4 py-5">
                        ...
                        <div
                            class="adses rounded grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-2 gap-x-5 gap-y-5">
                            <div class="bg-white rounded-md p-3">
                                <div class="flex justify-between">
                                    <div class="flex flex-col gap-y-3">
                                        ...
                                        <h4 class="text-md font-semibold hover:text-blue-500"><nuxt-link
                                                to="/user/message">Chat</nuxt-link></h4>
                                    </div>
                                    <div class="flex flex-col gap-y-3">
                    ...
                    <div class="bg-gray-100 rounded-md px-4 py-5 mt-6">
                        ...
                        <div
                            class="adses rounded grid grid-cols-2 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 gap-x-5 gap-y-5">
