...
<template>
    <div class="content">
        <div class="max-w-screen-2xl block h-full mx-auto px-4">
            <nav class="flex mb-3 mt-4" aria-label="Breadcrumb">
            ...
            <h1 class="font-bold text-2xl text-[rgba(245,_127,_32,_1)] mb-4 mt-3">Contact Us</h1>
                ...
                <aside class="w-64">
                    <div class="h-auto px-3 py-6 overflow-y-auto bg-[#F57F20]/35 dark:bg-gray-800 rounded-b-sm">
                        <div class="s-categories mb-3">
                            <h4 class="text-lg font-medium mb-4">Get in Touch</h4>
                            <p class="text-sm text-gray-700">
                                The Alumalite Big Step Side Bars install in minutes, providing great looks, convenience and safety for your vehicle. The Alumalite Big Step Side Bars install in minutes, providing great looks, convenience and safety for your vehicle.
                            </p>
                            <p class="text-sm text-gray-900 font-medium mt-3">New South Wles road , 25 Silicon Road, London D04 89GR</p>
                            <div class="mt-6">
                                <ul class="">
                                    <li class="pb-4">
                                        <div class="flex items-center gap-x-2">
                                            <svg class="w-4 h-4 text-orange-400 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
                                                <path d="M7.978 4a2.553 2.553 0 0 0-1.926.877C4.233 6.7 3.699 8.751 4.153 10.814c.44 1.995 1.778 3.893 3.456 5.572 1.68 1.679 3.577 3.018 5.57 3.459 2.062.456 4.115-.073 5.94-1.885a2.556 2.556 0 0 0 .001-3.861l-1.21-1.21a2.689 2.689 0 0 0-3.802 0l-.617.618a.806.806 0 0 1-1.14 0l-1.854-1.855a.807.807 0 0 1 0-1.14l.618-.62a2.692 2.692 0 0 0 0-3.803l-1.21-1.211A2.555 2.555 0 0 0 7.978 4Z"/>
                                            </svg>
                                            <span class="text-sm">+27 34 66 2455-198</span>
                                        </div>
                                    </li>
                                    <li class="pb-4">
                                        <div class="flex items-center gap-x-2">
                                            ...
                                            <span class="text-sm">info@chromium.com</span>
                                        </div>
                                    </li>
                                    <li class="pb-4">
                                        <div class="flex items-center gap-x-2">
                                            ...
                                            <span class="text-sm">Monday – Friday 8:00 to 19:00</span>
                                        </div>
                                    </li>
                                </ul>
                            </div>
                ...
                <div class="lg:w-[calc(100%-16rem)]">
                    ...
                    <div class="mx-auto w-full">
                        <div class="bg-white flex justify-center py-3">
                            <form class="p-4 md:p-5 w-4/5 shadow rounded">
                                ...
                                <button type="button" class="text-white flex justify-center items-center bg-gradient-to-br from-pink-500 to-orange-400 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-pink-200 dark:focus:ring-pink-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center">Send Message</button>
                            </form>
                        </div>
                    </div>
                </div>
        ...
        <div class="google-maps mt-4">
            <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d7303.803081458796!2d90.40272168770831!3d23.75089023487959!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3755b888ad339cb5%3A0x20c70986185ad2ba!2sMogbazar%2C%20Dhaka!5e0!3m2!1sen!2sbd!4v1711012197350!5m2!1sen!2sbd" width="100%" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
        </div>
    </div>
